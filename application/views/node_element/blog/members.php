            ...
            ?>
                <div id='<?php echo $pj['id']; ?>'>
                    <div class='strpanel notify rounded'>
                        ...
                        <span class='frbutton' onclick='accept(<?php echo $node['id']; ?>,<?php echo $pj['id']; ?>,"<?php echo $pj['name']; ?>","node_group")'>accept</span>
                        <span class='decline' onclick='decline(<?php echo $node['id']; ?>,<?php echo $pj['id']; ?>,"<?php echo $pj['name']; ?>")'>decline</span>
                    </div>
                </div>
            <?php
        }
